...
import { adjustStock, listStockEntries, type AdjustStockInput, type ListStockEntriesParams } from '@/api/stock.api';
import { queryKeys } from '@/lib/queryKeys';
import { useI18n } from '@/hooks/useI18n';
import { pushNotification } from '@/stores/notification.store';

export function useStockEntries(wsId: string, params: ListStockEntriesParams = {}) {
  return useQuery({
