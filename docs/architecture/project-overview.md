...
- ค้นหา item ได้เร็วจาก search เป็นทางเข้าหลัก
- ดู activity, reports, และ notifications เป็นชั้น audit/visibility

repo นี้คือ **frontend documentation + implementation guide** ของระบบดังกล่าว จึงเน้น flow หลักและหน้าจอที่ใช้งานจริงของระบบ
...
| Search | [modules/search.md](../modules/search.md) |
